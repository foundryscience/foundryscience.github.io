...
However, we know that cancer is a complex disease; we must consider not only the cancer cells themselves, but their lineage, the tumor microenvironment, and host immunity. We also need to consider how cancer cells adapt to treatments, and the patient's natural bodily responses to interventions.<Ref id="1"/>
